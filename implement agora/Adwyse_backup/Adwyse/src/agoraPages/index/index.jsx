...
import '../../agoraAssets/fonts/css/icons.css'
          ...
          <section className="login-wrapper">
            ...
            <div className="login-footer">
              <a id="joinBtn"
                ...
                className="ag-rounded button is-info">JoinCall
                  </a>
            </div>
          </section>
        </div>
    ...
    return (
      <div className="channel-wrapper control has-icons-left">
        ...
        <span className="icon is-small is-left">
          {/* <img src={require('../../agoraAssets/images/ag-login.png')} alt="" /> */}
        </span>
