...
<div  className="phonetotal">
            <label>
            <img src={SVGImages.PhoneIcon} alt="" /> </label>
            <div className="phonetext1"> Phone Number</div>
          
            <div className="field"><div className="fieldtext">Enter Number</div></div>
            </div>

            <div className="clinictotal">
            <label>
            <img src={SVGImages.PhoneIcon} alt="" /> </label>
            <div className="clinictext1"> Clinic Number*</div>
          
            <div className="clinic"><div className="clinictext">Alternate Number</div></div>
            </div>
<br></br>
...
<div  className="phonetotal">
            <label>
            <img src={SVGImages.Gender} alt="" /> </label>
            <div className="phonetext1"> Gender</div>
          
            <div className="field">
             <select className="fieldtext"  style={{ fontSize: "15px" }}>
               <option value="0">Select Gender</option>
               <option value="1">Male</option>
               <option value="2">Female</option>
               <option value="3">Other</option>
            ...
            <div className="clinictotal">
            <label>
            <img src={SVGImages.CalendarIcon} alt="" /> </label>
            <div className="clinictext1"> Date of Birth</div>
          
            <div className="clinic"><div className="clinictext">Enter Date of Birth</div></div>
            </div>
