...
export default function SimpleModal() {
  ...
  const body = (
    ...
    <div
      ...
      style={{ height: "634px", width: "391px", top: "6%", left: "-1%" }}
    >
      ...
      <div className="textuser1">
        <label className="image1">
          <span className="text12">Specialisation</span>
        </label>
      </div>
      ...
      <div className="card3">
        <label className="image22">
          <span className="title32">Cardiologist</span>
        </label>
      </div>
      <div className="card4">
      ...
      <div className="card5 color">
        <label className="image24">
          <span className="title32">ENT</span>
      ...
      <div className="card3">
        <label className="image25">
          <span className="title32">Ophthalmologist</span>
        </label>
      </div>
      <div className="card4 color">
        <label className="image26">
          <span className="title32">Dentist</span>
          <div className="sidecheck"></div>
        </label>
      </div>
      <div className="card5">
        <label className="image27">
          <span className="title32">Orthopedic</span>
        </label>
      </div>
      ...
      <div className="card3 color">
        <label className="image28">
          <span className="title32">pulmonologist</span>
          <div className="sidecheck"></div>
        </label>
      </div>
      <div className="card4">
        <label className="image29">
          <span className="title32">Urologist</span>
        </label>
      </div>
      <div className="card5">
        <label className="image30">
          <span className="title32">Neurosurgeon</span>
        </label>
      </div>
      ...
      >
        ...
        <span className="rightarrow1"></span>
      </Button>
    </div>
  );
