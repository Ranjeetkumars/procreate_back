...
export default class DoctorAvailability2 extends Component {
    render() {
        return (
             <div>
            <div style={main}>
            ...
            <span style={selectedday}>Monday</span>
            <span style={spamicon}></span>
            </div>
            </div>
            <div style={tuesday}> 
            <div style={{marginTop:"5px"}}>
            <span style={spammonday}>Tuesday</span>
            <span style={spamicon}></span>
            </div>
            </div>
            <div style={wednesday}> 
            ...
            <div style={monday}> 
            <div style={{marginTop:"5px"}}>
            <span style={selectedday}>Thursday</span>
            <span style={spamicon}></span>
            </div>
            </div>
            <div style={friday}> 
          ...
          <div className="rightArrowIcon" style={{marginTop:"-27px"}}></div>
          </button>
          </div> 
            <div>
          <label />
...
const main={
  background:"#FAFAFA",marginLeft:"-4px",width:"440px",height:"953px",margin:"auto",marginTop:"17px",
}
...
const step={
    marginLeft:"86px",height:"53px",width:"300px",color:"#2EB9AE",fontSize:"17px",marginBottom:"21px"
  }
