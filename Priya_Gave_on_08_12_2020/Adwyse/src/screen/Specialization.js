...
export default function Specialization() {
  ...
  const body = (
    ...
    <div style={modalStyle} className={classes.paper}style={{height:"540px",width:"330px" ,top:"6%",left:"5%" }}>
      {/* <h2 id="simple-modal-title"></h2> */}
     
      
        {/* closeicon */}
        <div className="closeiconr"  style={{ display: "flex",justifyContent:"space-around" }}></div>
...
<div className="card3r">
         ...
         <div className="card4r">
          ...
          <div className="card5r">           
           <label className="image30r"><span className="title32r">Neurosurgeon</span>
           </label>
           </div> 
           </div>
          </div>
