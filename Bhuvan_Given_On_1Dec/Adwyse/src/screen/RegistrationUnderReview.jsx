...
<div className="totallogo">
       ...
       <br></br><br></br>
      <p style={{ marginLeft:"61px",width:"260px",height:"66px",font:"italic normal var(--unnamed-font-weight-normal) 18px/22px var(--unnamed-font-family-lato)",letterSpacing:"var(--unnamed-character-spacing-0)",color:"var(--dark-gray)",textAlign:"center",font:"italic normal normal 18px/22px Lato",color: "hsla(214, 9%, 32%, 1)",opacity: "1"}}>Please feel free to explore the app, scheduling appointments will be active post confirmation.</p>
    
       <br></br>
      <p style={{ marginLeft:"51px",width:"272px",height:"22px",font:"italic normal var(--unnamed-font-weight-normal) 18px/22px var(--unnamed-font-family-lato);letter-spacing: var(--unnamed-character-spacing-0)",color:"var(--dark-gray)",textAlign:"center",font:"italic normal normal 18px/22px Lato",color: "hsla(214, 9%, 32%, 1)",opacity: "1"}}>We will update you via Email & SMS.</p>
        <div>
          <label />
            <br></br>

        <Button   style={{width: "340px",marginLeft: "17px",height: "50px",background: "var(--green) 0% 0% no-repeat padding-box",background: "#2EB9AE 0% 0% no-repeat padding-box",borderRadius: "6px",opacity: 1}} ><span class="span"    style={{ width: "133px",   
