...
export default class UpFrontPayment extends Component {
    render() {
      ...
      className="UpFrontPayment" >
       ...
       <p style={{marginTop: "26px",marginLeft: "37px",width: "265px",height: "36px",font: "var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-bold) 30px/40px var(--unnamed-font-family-lato)",letterSpacing: "var(--unnamed-character-spacing-0)",color: "var(--primary-blue)", textAlign: "left",font: "normal normal bold 30px/40px Lato",letterSpacing: "0px",color: "#2D5795",textTransform: "capitalize",opacity:"1"}}>Up Front Payment!</p>
     
     
       <p style={{marginLeft:"37px",width:"337",height:"47px",font:"var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-normal) 18px/25px var(--unnamed-font-family-lato)",letterSpacing: "var(--unnamed-character-spacing-0)",color:"var(--dark-gray)",textAlign:"left",font:"normal normal normal 18px/25px Lato",letterSpacing: "0px",color: "#4A5058", opacity: 1}}>Receive your consultation fees prior to appointment.</p>
