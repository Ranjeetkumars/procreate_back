    ...
    render() {
     ...
     <a href="#" className="skip">
      ...
      <div className="privacyGuaranteedLog">
       ...
       <p style={{marginTop: "26px",marginLeft: "37px",width: "270px",height: "36px",font: "var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-bold) 30px/40px var(--unnamed-font-family-lato)",letterSpacing: "var(--unnamed-character-spacing-0)",color: "var(--primary-blue)", textAlign: "left",font: "normal normal bold 30px/40px Lato",letterSpacing: "0px",color: "#2D5795",opacity:"1"}}>PrivacyGuaranteed!</p>
