...
export default class  GetStarted extends Component {
    render() {
        return (
            <div>
      <form className="form" style={{maxWidth: "21rem", margin: "0 auto"}}>
      <label>
...
<div  className="forwardArrow"><b  style={{ margintop:"0", marginLeft: "-159px",color:"#FFFFFF",font: "normal normal bold 16px/21px Lato"}} >Let’s get started</b></div>
          ...
          <p  style={{marginTop: "33px",marginLeft: "21px",width: "288px",height: "40px",letterSpacing: "var(--unnamed-character-spacing-0)",color: "var(--dark-gray)",textAlign: "center",font: "normal normal bold 16px/21px Lato",letterSpacing: "0px",color:"#4A5058",opacity: 1}}>Already have an account? <a href="#"> <b>Sign In</b></a></p>
