    ...
    return (
      <div style={main}>
       ...
       <AdwyseHeading/>
        ...
        <div>
        <img  src={SVGImages.Illustration} style={illustration} alt="" />
        </div>
        <div>
        <h3 style={stayupdated}>Stay Updated</h3>
        </div>
        <div>
        <p style={desc}>Allow push notifications to get real-time updates on appointments, transactions, messages & more!</p>
        </div>
